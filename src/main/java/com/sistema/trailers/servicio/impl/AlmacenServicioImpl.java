package com.sistema.trailers.servicio.impl;
...
public class AlmacenServicioImpl implements AlmacenServicio {
	...
	/*
	 * Esta anotacion sirve para indicar que este metodo se va a ejecutar cada que
	 * halla una nueva instancia de esta clase
	 */
	@PostConstruct
	@Override
